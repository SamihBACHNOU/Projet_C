...
typedef struct {
  Robot r;
  Terrain t;
	Etat etat_obs ; /** Etat courant de l’observateur **/
} Environnement;

/* Résultat de l’observateur : retourne vrai ssi l’état courant de l’observateur est un
état final (la propriété vérifiée par l’observateur est vraie) */
